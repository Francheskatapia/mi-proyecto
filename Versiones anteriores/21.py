...
if __name__ == "__main__":
    # Pregunta inicial para definir el modo
    ...
    if opcion == "1":
        ...
        if not args.ip:
            print("❌ Debes proporcionar una dirección IP con el argumento --ip.")
        else:
            if args.mascara:
    ...
    # se modificco el uso de argparse para usarlo por linea de comandos (opcional) o por modo normal (interactivo) (aun con errores)
